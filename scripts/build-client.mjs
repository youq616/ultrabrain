...
for(const [entry,name] of [['lineage.mjs','lineage.cjs'],['native-adapters.mjs','native-adapters.cjs'],['openclaw.mjs','openclaw.cjs']]) {
...
const hashes={};
for(const name of ['cli.cjs','native-adapters.cjs','openclaw.cjs','lineage.cjs']) {
