...
with tarfile.open(p) as t:
 ...
 required={'package/dist/overview.cjs','package/dist/snapshot.cjs','package/dist/snapshot-cli.cjs','package/dist/lineage.cjs','package/dist/cli.cjs','package/dist/native-adapters.cjs','package/dist/openclaw.cjs','package/openclaw.plugin.json','package/dist/native-adapter-config.py','package/dist/hermes-ultrabrain/__init__.py'}
