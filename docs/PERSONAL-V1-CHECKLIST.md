...
| 自动采集和类型化整理 | 已有授权会话采集/提取管线；全自动个人类型候选、冲突核对、定期整理的完整流程仍待完成。 |
| 客户端接入 | 自研 Agent/MCP/桥/n8n 有接入基元；Codex、Claude Code、ZCode、OpenCode、Grok CLI、Hermes、OpenClaw 的安装式适配与各自真实客户端验收未全部完成。 |
