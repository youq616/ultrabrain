...
export const migrations=['0001-baseline','0002-revision-evidence','0003-deferred-sessions','0004-summary-cache','0005-memory-policy','0006-instance-identity','0007-review-dependencies','0008-fact-evidence','0009-enterprise-admission','0010-personal-memory-core','0012-personal-core-wiring'].map(id =>
