...
const definitions=[
 ...
 ['ultra_project_save','save',true,{project_id,event_id:string('Stable immutable update identifier'),
   ...
   state:{type:'object',required:true,description:'goal, constraints, decisions, tasks (optional code_revision binds a full Git commit), blockers, next_actions; see docs/RELIABILITY.md'}},
 ...
 ['ultra_project_evidence','evidence',false,{project_id,receipt_id:string('Host execution receipt UUID')},
  'Read one source/project-scoped execution receipt and its optional Git observations. No remote execution or raw command output.'],
